...
import net.minecraft.block.Block;
	...
	public class TileEntityInfuser extends TileEntity implements IInventory, ITickable
	{
		...
		public void update() 
		{
			...
			if(!this.world.isRemote) 
			{
				...
				{
					flag1 = true;
					BlockInfuser.setState(this.isActive(), this.world, this.pos);
				}
			} 
		...
		public static int getItemBurnTime(ItemStack fuel) 
		{
			...
			else 
			{
				...
				if (item instanceof ItemBlock && Block.getBlockFromItem(item) != Blocks.AIR) 
				{
					...
					if (block == ModBlocks.REDSTONE_ALLOY_BLOCK) return 14400;
					if (block == Blocks.REDSTONE_BLOCK) return 7200;
					
				}
				if (item == ModItems.REDSTONE_ALLOY_INGOT) return 1600;
				if (item == Items.REDSTONE) return 800;
